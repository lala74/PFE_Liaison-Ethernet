...
#define MY_DEFAULT_MAC_BYTE1            (0x14)	// Use the default of 00-04-A3-00-00-00
#define MY_DEFAULT_MAC_BYTE2            (0x58)	// if using an ENCX24J600, MRF24WB0M, or
#define MY_DEFAULT_MAC_BYTE3            (0xD0)	// PIC32MX6XX/7XX internal Ethernet 
#define MY_DEFAULT_MAC_BYTE4            (0x18)	// controller and wish to use the 
#define MY_DEFAULT_MAC_BYTE5            (0x94)	// internal factory programmed MAC
#define MY_DEFAULT_MAC_BYTE6            (0x71)	// address instead.

//#define MY_DEFAULT_MAC_BYTE1            (0x71)	// Use the default of 00-04-A3-00-00-00
//#define MY_DEFAULT_MAC_BYTE2            (0x94)	// if using an ENCX24J600, MRF24WB0M, or
//#define MY_DEFAULT_MAC_BYTE3            (0x18)	// PIC32MX6XX/7XX internal Ethernet 
//#define MY_DEFAULT_MAC_BYTE4            (0xD0)	// controller and wish to use the 
//#define MY_DEFAULT_MAC_BYTE5            (0x58)	// internal factory programmed MAC
//#define MY_DEFAULT_MAC_BYTE6            (0x14)	// address instead.
